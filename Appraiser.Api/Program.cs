    ...
    public static class Program
    {
        ...
        public static int Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .Enrich.WithProperty("ApplicationName", "Appraiser-Api")
                .WriteTo.Console()
                .WriteTo.RollingFile(Path.Combine(LogFileLocation(), @"Appraiser-Api-{Date}.txt"))
            ...
            try
            {
                Log.Information("Starting Appraiser-API");
